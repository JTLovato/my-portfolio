const data = {
    ...
    blogs: [
        {
            _id: 'imposter_syndrome',
            title: "Imposter Syndrome",
            subTitle: "Compare Yourself To Yourself",
            quote: "No One Likes To Post Their Failures",
            date: "4/26/2021",
            card: "../img/blog/imposter-button.jpg",
            src: "../img/blog/imposter-header.jpg",
            text: <>Let’s do a thought exercise, shall we? Let us say that you have a hobby. A past time that you love and are passionate about. And you’ve been doing it for years, and have gotten pretty good at it. For this exercise let’s say that it’s baking. Every week you come home and bake some cupcakes, or a nice set of apple pastries, and your friends and family love them and compliment you on them every time. You feel pretty good about yourself! Then you see they’re holding a baking competition nearby and you decide to enter. You go and set up camp, enter the competition, but for some reason you get completely blown out of the water. Just demolished.You don’t place, you don’t make it to the next round, whatever. So you ask around, you ask the other contestants how long they’ve been baking, and with what, and so on. And to your surprise, they’ve been baking for far less time than you, and using the same pans, and the same ingredients, but for some reason they’re just better than you are. You suddenly don’t feel like such a great baker anymore.<br /><br />Imposter Syndrome is when you’re pretty good or even great at something, but when you compare yourself to others you suddenly don’t feel like you belong in the same echelon as them. I know I’ve personally felt this often while looking for jobs in both tech and design. I’ve over a decade’s experience in graphic design, but I feel like I don’t belong with other artists because I never obtained a degree. I can write pretty good HTML, CSS, JavaScript and React, but when I see jobs looking for that, plus 4+ years of coding experience, in React, Angular, Vue, PHP, and more, I feel like I can’t come close to competing. Does this mean I’m not a good web developer? No, not at all, and that is a fact I constantly have to remind myself of when I get my 500th rejection email. So what can we do when we feel like this? Well, a lot actually. <br /><br />One of the best things we can do is recognize that we don’t see everything successful people have gone through. One of the reasons that we may have imposter syndrome is because we hold ourselves to an impossible standard, often set by seeing people in our chosen field achieve and surpass their goals. How often do we see on Twitter “I just accepted my job at Google” or “Finally sold my business to Facebook for $1.2 Billion dollars”? We don’t see all the failures those people went through, how many job applications that were rejected, or how many businesses failed before that big one sold, and that’s because no one likes to post their failures. We don’t get to see all the hard work they did, all the schooling and long nights studying in order to succeed. We have to recognize that when we fail at something, or feel the tiring feeling of applying for so many jobs, that they did too, and often the only difference is time or luck. <br /><br />One thing we can do to better move past feeling this way is to eventually normalize failure. Failing at something isn’t the end-all-be-all, it’s just another step. We have to feel better about sharing our missteps, and we have to be more understanding when people do. It’s easy to share these after the fact, easy to look back and see how far you’ve come and laugh at the earlier struggles, but in the moment it hurts. It’s draining. Having a support group that helps push you through those times and then celebrates with you when you succeed is something that would help so many more people. Instead of one person succeeding, it’s several. <br /><br />Another thing we can do to help imposter syndrome is listen. A survey taken in late 2020 says that over 75% of women in the workforce experience some kind of imposter syndrome, with women of color being a majority of that number. The thought is that if they share how they’re feeling, it’ll only prove that feeling. After all, you don’t hear about successful people sharing that they feel like imposters, right? But I’d be willing to bet the majority of them do more often than not. So creating a space that allows people to feel safe about opening up and not being judged is paramount to helping everyone feel better about themselves and growing. <br /><br />Don’t feel bad because you can’t bake a cake as well as someone else. Find people who will enjoy your cake, and help you grow to become a better baker.</>,
        },
        {
            _id: 'job_scams',
            title: "Job Scams",
        ...
        {
            _id: 'how_to_deal_with_distractions',
