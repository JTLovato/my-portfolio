            ...
            <div className="about-container">
                ...
                <div className="about-info-container">
                    <div className="about-info">
                        ...
                        <p>John has lived in several parts of the US and currently calls <span>Denver</span> his home. When he's not on VCS or Photoshop, John likes to play video games, watches and plays hockey, roots for the Avalanche, and plays with his <span>girlfriend and two dogs</span>.</p>
                    </div>
                </div>
            </div>
        </div>
